...
def updateHand(hand, word):
    ...
    for i in word:
        return_hand[i] = return_hand.get(i) - 1
    return return_hand
...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        for i in word:
            if i in check_hand and check_hand[i] > 0:
                check_hand[i] = check_hand.get(i) - 1
            else:
                return False
        return True
    else:
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                score += word_score
                print(user_input + " earned {} points. Total: {} points".format(word_score, score))
                print()
                # Update the hand
